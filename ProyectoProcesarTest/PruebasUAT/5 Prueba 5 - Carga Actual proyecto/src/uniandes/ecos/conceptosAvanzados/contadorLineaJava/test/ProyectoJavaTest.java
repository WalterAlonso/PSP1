/**
 * Propósito:     Representa la clase a testear ProyectoJava.
...
public class ProyectoJavaTest extends TestCase {
    ...
    public void testProyectoVacio() {
    	try {
    		...
    		assertEquals( "El mensaje debe coincidir: No se encontro ningún archivo para procesar.", "No se encontro ningún archivo para procesar.", ex.getMessage());
    	}
    }
    	...
    	try {
    		...
    		for (int indice = 0; indice < paquetes.size(); indice ++) {
    			...
    			if (paquete.darNombre().equals("uniandes.ecos.conceptosAvanzados.modelo")) {
    				...
    				assertEquals( "El paquete modelo debe tener 29 lineas lógicas", 29, paquete.darCantidadLineasLogicas());
    				assertEquals( "El paquete modelo debe tener 29 lineas lógicas", 29, paquete.darCantidadLineasLogicas());
    			...
    			if (paquete.darNombre().equals("uniandes.ecos.conceptosAvanzados.controlador")) {
    				...
    				assertEquals( "El paquete controlador debe tener 20 lineas lógicas", 20, paquete.darCantidadLineasLogicas());    				
    			...
    			if (paquete.darNombre().equals("No paquete")) {
    				...
    				assertEquals( "El No paquete debe tener 11 lineas lógicas", 11, paquete.darCantidadLineasLogicas());
