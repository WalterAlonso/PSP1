...
public class ArchivoJava {
	...
	/**
	 * Indica la ubicacion fisica del archivo.
	 */
	 ...
	 * @param ubicacionFisica : ubicacion fisica del archivo
	 * @param nombreArhivo : nombre del archivo
	 */
	 ...
	 * @throws Exception : al cargar el archivo puede generar excepcion
	 */
	 ...
	 * @return da numero lineas logicas
	 */
	 ...
	 * @return boleano para manejo recursivo de analisis linea a linea
	 * @throws Exception si hay problema en la lectura del archivo
	 */
	 ...
	 * @param instruccion : la linea que se esta proceando.
	 * @return booleano que indica si es clase, interfaz o enumerador.
	 * @throws Exception si hay problema en los casteos
	 */
	 ...
	 * @param instruccion : la linea que se esta analizand.
	 * @return si es finalizacion de comentario.
	 */
	 ...
	 * @param linea : instruccion que se esta analizando
	 * @return instruccion sin espacios.
	 */
	 ...
	 * @param linea : instruccion que se esta procesando.
	 * @return si es vacia.
	 */
	 ...
	 * @return si hay comentario abierto. 
	 */
	 ...
	 * @param instruccion : instruccion que se esta procesando.
	...
	/**
	 * Suma 1 a la actual cantidad de linea logica.
	 */
	 ...
	 * @param instruccion : instruccion que se esta procesando.
	 * @return si es paquete la instruccion
	 */
	 ...
	 * @param instruccion : instruccion que se esta procesando.
	 * @param tipoArchivo : si es clase o interfaz o enum.
	 * @return si es calse, interfaz o enum
	 */
	 ...
	 * o un condicional.
	 * @param instruccion : instruccion que se esta procesando.
	 * @return si tiene corchete y parentesis
	 */
	 ...
	 * @param tipoEstructura : el tipo de estructura, tipo archivo (clase, interfaz, enum)
	 */
